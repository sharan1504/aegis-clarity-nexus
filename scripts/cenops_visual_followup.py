...
# Remove the temporary CI self-modification step before committing the real source changes.
ci = Path(".github/workflows/ci.yml")
ci_text = ci.read_text(encoding="utf-8")
ci_text = re.sub(r'\n      - name: Apply CenOps visual follow-up.*?git push origin "HEAD:\${GITHUB_HEAD_REF}"\n', '\n', ci_text, flags=re.S)
