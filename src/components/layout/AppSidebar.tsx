...
export function AppSidebar() {
  ...
  return <Sidebar collapsible="icon">
    ...
    <SidebarContent>
      ...
      {!collapsed && <SidebarGroup><SidebarGroupContent><Link to="/platform/chat" className="flex w-full items-center gap-2 rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90"><Sparkles className="h-4 w-4" /><span>Ask Cenops</span></Link></SidebarGroupContent></SidebarGroup>}
