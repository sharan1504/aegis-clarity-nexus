...
import { LayoutDashboard, Bot, Plug, MessageSquare, ShieldAlert, ShieldCheck, FileBarChart, Users, Settings, Sparkles, Store, History, BarChart3 } from "lucide-react";
...
const nav = [
  ...
  { section: "Data & Systems", items: [{ title: "Integrations", url: "/integrations", icon: Plug }, { title: "Audit Viewer", url: "/audit", icon: History }, { title: "Reports", url: "/reports", icon: FileBarChart }] },
