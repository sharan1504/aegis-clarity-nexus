...
const nav = [
  { section: "Overview", items: [{ title: "Dashboard", url: "/", icon: LayoutDashboard }] },
  {
        ...
        <div className="flex items-center gap-2.5 px-2 py-2.5">
          ...
          {!collapsed && (
            <div className="flex flex-col leading-tight">
              <span className="text-sm font-semibold tracking-tight">Aegis AI</span>
      ...
      <SidebarFooter className="border-t border-sidebar-border">
        {!collapsed ? (
          <div className="px-2 py-2 text-[11px] text-muted-foreground">
            <div className="font-medium text-sidebar-foreground">Contoso Corp</div>
            <div>Tenant • Production</div>
          </div>
        ) : (
          <div className="flex justify-center py-2 text-xs text-muted-foreground">C</div>
        )}
      </SidebarFooter>
    </Sidebar>
  );
