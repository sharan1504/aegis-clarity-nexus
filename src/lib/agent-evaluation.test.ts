...
const run: AgentRunState = {
  runId: "run-1", tenantId: "tenant-1", agentKey: "agent-security", status: "waiting_approval", currentStep: "approval",
  input: "Find high security findings and recommend remediation.", plan: { steps: ["investigate", "policy", "approval"] },
  evidence: [{ provider: "github", findings: [{ id: "GH-1", severity: "high" }] }],
  policyVerdict: { recommendations: [{ findingId: "GH-1", action: "remediate" }] }, approval: { status: "pending" }, execution: null, verification: null,
  error: null, createdAt: "2026-09-09T00:00:00.000Z", updatedAt: "2026-09-09T00:01:00.000Z",
};
