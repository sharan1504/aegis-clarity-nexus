...
export interface NormalizedEntitlement { provider: string; integrationId: string; userId: string; userName: string | null; userEmail: string | null; entitlementId: string; entitlementName: string | null; status: "active" | "inactive" | "unknown"; lastActivityAt: string | null; metadata: Record<string, unknown>; provenance: RecordProvenance; }
export interface NormalizedUser { provider: string; integrationId: string; userId: string; userName: string | null; userEmail: string | null; status: string | null; lastActivityAt: string | null; metadata: Record<string, unknown>; provenance: RecordProvenance; }
export interface NormalizedQueue { provider: string; integrationId: string; queueId: string; queueName: string | null; memberCount: number | null; metadata: Record<string, unknown>; provenance: RecordProvenance; }
export type NormalizedFindingSeverity = "low" | "medium" | "high" | "critical" | "unknown";
export interface NormalizedRepository { provider: string; integrationId: string; repositoryId: string; repositoryName: string; url: string | null; private: boolean | null; archived: boolean | null; defaultBranch: string | null; pushedAt: string | null; providerUpdatedAt: string | null; metadata: Record<string, unknown>; provenance: RecordProvenance; }
export interface NormalizedSecurityFinding { provider: string; integrationId: string; findingId: string; repositoryName: string | null; findingType: string; title: string | null; severity: NormalizedFindingSeverity; state: string | null; url: string | null; providerUpdatedAt: string | null; metadata: Record<string, unknown>; provenance: RecordProvenance; }
