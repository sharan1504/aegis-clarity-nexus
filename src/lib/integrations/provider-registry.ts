...
export const PROVIDER_REGISTRY: ProviderDefinition[] = [
  ...
  { id: "freshworks", name: "Freshworks", category: "ITSM & Customer Support", description: "Freshservice, Freshdesk, tickets, assets and SLAs.", auth: "OAuth 2.0", scopes: ["freshservice.tickets.view", "freshservice.tickets.edit", "freshservice.tickets.conversations.create"], capabilities: ["read", "write", "sync"], availability: "available", logoUrl: logo("freshworks") },
