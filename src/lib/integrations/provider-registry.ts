...
export const PROVIDER_REGISTRY: ProviderDefinition[] = [
  ...
  { id: "jira", name: "Jira", category: "ITSM", description: "Issues, projects, workflows and automation.", auth: "OAuth 2.0", scopes: ["read:jira-work", "write:jira-work"], capabilities: ["read", "write", "sync"] },
  { id: "servicenow", name: "ServiceNow", category: "ITSM", description: "Incidents, changes and CMDB.", auth: "OAuth 2.0", scopes: ["provider-managed"], capabilities: ["read", "write", "sync"] },
