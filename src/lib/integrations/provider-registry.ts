...
export const PROVIDER_REGISTRY: ProviderDefinition[] = [
  ...
  { id: "jira", name: "Jira", category: "ITSM & DevOps", description: "Issues, projects, workflows and automation.", auth: "OAuth 2.0", scopes: ["read:jira-work", "read:jira-user", "write:jira-work"], capabilities: ["read", "write", "sync"], availability: "available", logoUrl: logo("jira") },
