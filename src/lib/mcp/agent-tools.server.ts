...
/**
 * Resolve the MCP tools an agent may discover at runtime.
 *
 * Availability is derived from persisted agent data-source bindings. This
 * helper only narrows discovery; the existing MCP governance gate remains the
 * final authorization boundary for every invocation.
 */
