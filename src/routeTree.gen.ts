...
const AppIntegrationsCatalogRoute = AppIntegrationsCatalogRouteImport.update({
  id: '/catalog',
  path: '/catalog',
  getParentRoute: () => AppIntegrationsRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_app/integrations/catalog/$providerId': {
      ...
      path: '/$providerId'
      fullPath: '/integrations/catalog/$providerId'
      preLoaderRoute: typeof AppIntegrationsCatalogProviderIdRouteImport
      parentRoute: typeof AppIntegrationsCatalogRoute
    }
  }
}
...
const AppIntegrationsCatalogRouteWithChildren =
  AppIntegrationsCatalogRoute._addFileChildren(
    AppIntegrationsCatalogRouteChildren,
  )
