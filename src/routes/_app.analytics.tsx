          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <Popover open={rangeOpen} onOpenChange={setRangeOpen}>
              ...
              <PopoverContent align="end" className="w-[340px] p-0">
                <div className="border-b p-1"><div className="grid grid-cols-2 gap-1"><Button size="sm" variant={rangeTab === "relative" ? "secondary" : "ghost"} onClick={() => setRangeTab("relative")}>Relative</Button><Button size="sm" variant={rangeTab === "custom" ? "secondary" : "ghost"} onClick={() => setRangeTab("custom")}>Custom</Button></div></div>
