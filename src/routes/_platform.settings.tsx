...
export const Route = createFileRoute("/_platform/settings")({ head: () => pageHead({ path: "/platform/settings", title: "Workspace Settings — Cenops", description: "Manage organization, security, appearance, AI safety and workspace preferences." }), component: SettingsPage });
